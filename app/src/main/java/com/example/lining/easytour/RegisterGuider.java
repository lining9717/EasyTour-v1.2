...
//    private RegisterGuider context;
...
//    //动态获取权限监听
//    private static PermissionListener mgListener;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_r_g_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(username.equals("")){
                    Toast.makeText(RegisterGuider.this,"用户名未输入",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(psw.equals("")){
                    Toast.makeText(RegisterGuider.this,"密码未输入",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(realname.equals("")){
                    Toast.makeText(RegisterGuider.this,"真实姓名未输入",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(tel.equals("")){
                    Toast.makeText(RegisterGuider.this,"手机号码未输入",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(IDnumber.equals("")){
                    Toast.makeText(RegisterGuider.this,"身份证号未输入",Toast.LENGTH_SHORT).show();
                    return;
                }

                //测试时先注释
//                if(!isMobile(tel)){
//                    Toast.makeText(RegisterGuider.this,"手机号码格式错误",Toast.LENGTH_SHORT).show();
//                    return;
//                }
//                if(!is18ByteIdCard(IDnumber)){
//                    Toast.makeText(RegisterGuider.this,"身份证格式错误",Toast.LENGTH_SHORT).show();
//                    return;
//                }
...
//        this.context = this;
//        showImageView = (ImageView) findViewById(R.id.register_giv_usericon);
//
//        cachPath=getDiskCacheDir(this)+ "/crop_image.jpg";
//        cacheFile =getCacheFile(new File(getDiskCacheDir(this)),"crop_image.jpg");
//        imageView= (ImageView) findViewById(R.id.register_giv_usericon);
...
//
//    public void btnChangeGUserIcon(View view) {
...
//            imageUri = FileProvider.getUriForFile(RegisterGuider.this, "com.wing.phototest.fileprovider", cameraFile);
//
//        }
//        // 启动相机程序
...
//            if (ContextCompat.checkSelfPermission(RegisterGuider.this, permission) != PackageManager.PERMISSION_GRANTED) {
//                permissionList.add(permission);
//            }
//        }
//        if (!permissionList.isEmpty()) {
//            ActivityCompat.requestPermissions(RegisterGuider.this, permissionList.toArray(new String[permissionList.size()]), 1);
//        } else {
//            mgListener.onGranted();
//        }
//    }
//    @TargetApi(23)
//    @Override
...
//                        mgListener.onGranted();
//                    } else {
//                        mgListener.onDenied(deniedPermissions);
//                    }
//                }
//                break;
//            default:
...
//    }
    ...
    private class GuiderRegister extends AsyncTask<String, Void, Integer>{
        ...
        protected void onPostExecute(Integer integer) {
            ...
            if(integer == 0){
                Toast.makeText(RegisterGuider.this,"注册失败,服务器错误",Toast.LENGTH_SHORT).show();
            }
            if(integer == 1){
                Toast.makeText(RegisterGuider.this,"注册成功",Toast.LENGTH_LONG).show();
                finish();
            }
            if(integer == 2){
                Toast.makeText(RegisterGuider.this,"用户名已存在",Toast.LENGTH_SHORT).show();
            }
        }
    }
